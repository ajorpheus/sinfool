...
static bool _logos_method$_ungrouped$CAMUserPreferences$isIrisCaptureEnabled(_LOGOS_SELF_TYPE_NORMAL CAMUserPreferences* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    return 1;
}



static bool _logos_method$_ungrouped$PUAssetViewModel$wantsIrisBadgeVisible(_LOGOS_SELF_TYPE_NORMAL PUAssetViewModel* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    return 1;
}


static __attribute__((constructor)) void _logosLocalInit() {
{Class _logos_class$_ungrouped$AVCaptureDeviceFormat = objc_getClass("AVCaptureDeviceFormat"); { MSHookMessageEx(_logos_class$_ungrouped$AVCaptureDeviceFormat, @selector(isIrisSupported), (IMP)&_logos_method$_ungrouped$AVCaptureDeviceFormat$isIrisSupported, (IMP*)&_logos_orig$_ungrouped$AVCaptureDeviceFormat$isIrisSupported);}Class _logos_class$_ungrouped$CAMCaptureCapabilities = objc_getClass("CAMCaptureCapabilities"); { MSHookMessageEx(_logos_class$_ungrouped$CAMCaptureCapabilities, @selector(isBackIrisSupported), (IMP)&_logos_method$_ungrouped$CAMCaptureCapabilities$isBackIrisSupported, (IMP*)&_logos_orig$_ungrouped$CAMCaptureCapabilities$isBackIrisSupported);}{ MSHookMessageEx(_logos_class$_ungrouped$CAMCaptureCapabilities, @selector(isFrontIrisSupported), (IMP)&_logos_method$_ungrouped$CAMCaptureCapabilities$isFrontIrisSupported, (IMP*)&_logos_orig$_ungrouped$CAMCaptureCapabilities$isFrontIrisSupported);}Class _logos_class$_ungrouped$CAMUserPreferences = objc_getClass("CAMUserPreferences"); { MSHookMessageEx(_logos_class$_ungrouped$CAMUserPreferences, @selector(isIrisCaptureEnabled), (IMP)&_logos_method$_ungrouped$CAMUserPreferences$isIrisCaptureEnabled, (IMP*)&_logos_orig$_ungrouped$CAMUserPreferences$isIrisCaptureEnabled);}Class _logos_class$_ungrouped$PUAssetViewModel = objc_getClass("PUAssetViewModel"); { MSHookMessageEx(_logos_class$_ungrouped$PUAssetViewModel, @selector(wantsIrisBadgeVisible), (IMP)&_logos_method$_ungrouped$PUAssetViewModel$wantsIrisBadgeVisible, (IMP*)&_logos_orig$_ungrouped$PUAssetViewModel$wantsIrisBadgeVisible);}} }
#line 33 "Tweak.xm"
