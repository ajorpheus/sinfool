...
static URLCompletionProvider* _logos_method$_ungrouped$URLCompletionProvider$initWithBookmarkCollection$cloudTabStore$maxResults$searchableCollectionsMask$(_LOGOS_SELF_TYPE_INIT URLCompletionProvider* __unused self, SEL __unused _cmd, id arg1, id arg2, unsigned long long arg3, int arg4) _LOGOS_RETURN_RETAINED {
    arg3 = 0;
    return _logos_orig$_ungrouped$URLCompletionProvider$initWithBookmarkCollection$cloudTabStore$maxResults$searchableCollectionsMask$(self, _cmd, arg1, arg2, arg3, arg4);
}


static __attribute__((constructor)) void _logosLocalInit() {
{Class _logos_class$_ungrouped$URLCompletionProvider = objc_getClass("URLCompletionProvider"); { MSHookMessageEx(_logos_class$_ungrouped$URLCompletionProvider, @selector(initWithBookmarkCollection:cloudTabStore:maxResults:searchableCollectionsMask:), (IMP)&_logos_method$_ungrouped$URLCompletionProvider$initWithBookmarkCollection$cloudTabStore$maxResults$searchableCollectionsMask$, (IMP*)&_logos_orig$_ungrouped$URLCompletionProvider$initWithBookmarkCollection$cloudTabStore$maxResults$searchableCollectionsMask$);}} }
#line 10 "Tweak.xm"
