...
@class SBControlCenterController; @class SBNotificationCenterController; @class UIStatusBarStyleRequest; @class SpringBoard; @class SBAppStatusBarTransitionInfo; 
