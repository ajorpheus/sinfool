...
@class UIAlertControllerVisualStyle; 
...
{Class _logos_class$_ungrouped$UIAlertControllerVisualStyle = objc_getClass("UIAlertControllerVisualStyle"); { MSHookMessageEx(_logos_class$_ungrouped$UIAlertControllerVisualStyle, @selector(hideActionSeparators), (IMP)&_logos_method$_ungrouped$UIAlertControllerVisualStyle$hideActionSeparators, (IMP*)&_logos_orig$_ungrouped$UIAlertControllerVisualStyle$hideActionSeparators);}} }
#line 9 "Tweak.xm"
