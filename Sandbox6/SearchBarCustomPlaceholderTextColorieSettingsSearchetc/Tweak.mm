...
@class UISearchBarTextFieldLabel; 
static void (*_logos_orig$_ungrouped$UISearchBarTextFieldLabel$setTextColor$)(_LOGOS_SELF_TYPE_NORMAL UISearchBarTextFieldLabel* _LOGOS_SELF_CONST, SEL, id); static void _logos_method$_ungrouped$UISearchBarTextFieldLabel$setTextColor$(_LOGOS_SELF_TYPE_NORMAL UISearchBarTextFieldLabel* _LOGOS_SELF_CONST, SEL, id); 
