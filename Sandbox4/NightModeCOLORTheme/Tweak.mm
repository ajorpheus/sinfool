...
static BOOL _logos_method$_ungrouped$UITableViewCell$_backgroundColorSet(_LOGOS_SELF_TYPE_NORMAL UITableViewCell* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
