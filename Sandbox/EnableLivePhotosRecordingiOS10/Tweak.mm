...
static bool _patched_ftt_meth_$CAMUserPreferences$isIrisCaptureEnabled(id self, SEL _cmd) {
    return 1;
}
...
static __attribute__((constructor)) void _fttLocalInit() {
    ...
    MSHookMessageEx(_ftt_class_CAMUserPreferences, @selector(isIrisCaptureEnabled), (IMP)_patched_ftt_meth_$CAMUserPreferences$isIrisCaptureEnabled, NULL);
}
