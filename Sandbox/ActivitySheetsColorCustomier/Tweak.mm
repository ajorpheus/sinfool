...
static void (*_orig_ftt_meth_$_UIPopoverStandardChromeView$setPopoverBackgroundColor$)(id, SEL, id);
static void _patched_ftt_meth_$_UIPopoverStandardChromeView$setPopoverBackgroundColor$(id self, SEL _cmd, id arg1) {
    // Background: Set Color...
    arg1 = [UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:190/255.0];
    _orig_ftt_meth_$_UIPopoverStandardChromeView$setPopoverBackgroundColor$(self, _cmd, arg1);
}
...
static __attribute__((constructor)) void _fttLocalInit() {
    Class _ftt_class__UIPopoverStandardChromeView = objc_getClass("_UIPopoverStandardChromeView");
    MSHookMessageEx(_ftt_class__UIPopoverStandardChromeView, @selector(setPopoverBackgroundColor:), (IMP)_patched_ftt_meth_$_UIPopoverStandardChromeView$setPopoverBackgroundColor$, (IMP *)_orig_ftt_meth_$_UIPopoverStandardChromeView$setPopoverBackgroundColor$);
