...
static id _patched_ftt_meth_$MTVBrowseAdTileView$initWithFrame$(id self, SEL _cmd, CGRect arg1) {
    return NULL;
}
...
static __attribute__((constructor)) void _fttLocalInit() {
    ...
    MSHookMessageEx(_ftt_class_MTVBrowseAdTileView, @selector(initWithFrame:), (IMP)_patched_ftt_meth_$MTVBrowseAdTileView$initWithFrame$, NULL);
