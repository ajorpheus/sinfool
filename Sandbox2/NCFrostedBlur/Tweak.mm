...
static bool _logos_method$_ungrouped$SBNotificationCenterViewController$tintsBackground(_LOGOS_SELF_TYPE_NORMAL SBNotificationCenterViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    return 0;
}


static __attribute__((constructor)) void _logosLocalInit() {
{Class _logos_class$_ungrouped$SBNotificationCenterViewController = objc_getClass("SBNotificationCenterViewController"); { MSHookMessageEx(_logos_class$_ungrouped$SBNotificationCenterViewController, @selector(_defaultBackdropViewStyle), (IMP)&_logos_method$_ungrouped$SBNotificationCenterViewController$_defaultBackdropViewStyle, (IMP*)&_logos_orig$_ungrouped$SBNotificationCenterViewController$_defaultBackdropViewStyle);}{ MSHookMessageEx(_logos_class$_ungrouped$SBNotificationCenterViewController, @selector(tintsBackground), (IMP)&_logos_method$_ungrouped$SBNotificationCenterViewController$tintsBackground, (IMP*)&_logos_orig$_ungrouped$SBNotificationCenterViewController$tintsBackground);}} }
#line 15 "Tweak.xm"
