...
static MTVBrowseAdTileView* _logos_method$_ungrouped$MTVBrowseAdTileView$initWithFrame$(_LOGOS_SELF_TYPE_INIT MTVBrowseAdTileView* __unused self, SEL __unused _cmd, CGRect arg1) _LOGOS_RETURN_RETAINED {
    return NULL;
}
