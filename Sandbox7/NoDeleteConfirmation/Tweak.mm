...
@class PUDeletePhotosActionController; 
...
{Class _logos_class$_ungrouped$PUDeletePhotosActionController = objc_getClass("PUDeletePhotosActionController"); { MSHookMessageEx(_logos_class$_ungrouped$PUDeletePhotosActionController, @selector(shouldSkipDeleteConfirmation), (IMP)&_logos_method$_ungrouped$PUDeletePhotosActionController$shouldSkipDeleteConfirmation, (IMP*)&_logos_orig$_ungrouped$PUDeletePhotosActionController$shouldSkipDeleteConfirmation);}} }
#line 9 "Tweak.xm"
