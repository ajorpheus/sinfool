...
{Class _logos_class$_ungrouped$PUAlbumListViewController = objc_getClass("PUAlbumListViewController"); { MSHookMessageEx(_logos_class$_ungrouped$PUAlbumListViewController, @selector(_containsAnyAssets:), (IMP)&_logos_method$_ungrouped$PUAlbumListViewController$_containsAnyAssets$, (IMP*)&_logos_orig$_ungrouped$PUAlbumListViewController$_containsAnyAssets$);}} }
#line 9 "Tweak.xm"
