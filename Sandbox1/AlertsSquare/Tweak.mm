...
@class UIAlertControllerVisualStyleActionSheet; @class UIAlertControllerVisualStyleAlert; 
static float (*_logos_orig$_ungrouped$UIAlertControllerVisualStyleAlert$backgroundCornerRadius)(_LOGOS_SELF_TYPE_NORMAL UIAlertControllerVisualStyleAlert* _LOGOS_SELF_CONST, SEL); static float _logos_method$_ungrouped$UIAlertControllerVisualStyleAlert$backgroundCornerRadius(_LOGOS_SELF_TYPE_NORMAL UIAlertControllerVisualStyleAlert* _LOGOS_SELF_CONST, SEL); static float (*_logos_orig$_ungrouped$UIAlertControllerVisualStyleActionSheet$backgroundCornerRadius)(_LOGOS_SELF_TYPE_NORMAL UIAlertControllerVisualStyleActionSheet* _LOGOS_SELF_CONST, SEL); static float _logos_method$_ungrouped$UIAlertControllerVisualStyleActionSheet$backgroundCornerRadius(_LOGOS_SELF_TYPE_NORMAL UIAlertControllerVisualStyleActionSheet* _LOGOS_SELF_CONST, SEL); 

#line 3 "Tweak.xm"

static float _logos_method$_ungrouped$UIAlertControllerVisualStyleAlert$backgroundCornerRadius(_LOGOS_SELF_TYPE_NORMAL UIAlertControllerVisualStyleAlert* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
...
static float _logos_method$_ungrouped$UIAlertControllerVisualStyleActionSheet$backgroundCornerRadius(_LOGOS_SELF_TYPE_NORMAL UIAlertControllerVisualStyleActionSheet* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
